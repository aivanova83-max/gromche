          ...
          <ScrollReveal>
            <div className="text-center space-y-6">
              ...
              <p className="text-lg md:text-xl text-foreground/80 leading-relaxed max-[480px]:text-base">
                ...
                сам — что-то происходит на самом глубоком уровне души. Что-то
                очень древнее и очень живое.
              </p>
              <p className="text-foreground/70 leading-relaxed max-[480px]:text-sm">
                Этот вечер — застолье с самоваром, баяном и песнями, которые
                люди пели столетиями до нас. Приходите петь вместе.
              </p>
            </div>
          </ScrollReveal>
        </div>
