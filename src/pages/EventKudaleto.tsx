        ...
        <div className="container max-w-3xl mx-auto">
          <ScrollReveal>
            <div className="text-center space-y-6">
              ...
              <p className="md:hidden text-foreground/70 leading-relaxed max-[480px]:text-sm">
                Будем петь то, что помним с детства и любим до сих пор —
                музыку из фильмов, в основном советских. «Служебный роман»,
                «Мэри Поппинс», «Иван Васильевич» и другие.
              </p>
              <p className="max-md:hidden text-foreground/70 leading-relaxed">
                Будем петь то, что помним с детства и любим до сих пор —
                музыку из фильмов, в основном советских. «Служебный роман»,
