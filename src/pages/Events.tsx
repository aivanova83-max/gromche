...
},
{
  ...
  text: "Игристое настроение и фуршетные закуски для идеального дополнения к музыке"
}];
          ...
          <ScrollReveal>
            <div className="text-center space-y-6">
              ...
              <p className="text-lg md:text-xl text-foreground/80 leading-relaxed max-[480px]:text-base">
                ...
                <br />
                Это формат, где главные герои не на сцене, а в зале.
              </p>
              <p className="text-foreground/70 leading-relaxed max-[480px]:text-sm">
                Все присутствующие вместе образуют хор. Голос каждого усиливает
                общее звучание — и сам наполняется силой. Даже если раньше вы
                думали, что «не поёте».
              </p>
            </div>
          </ScrollReveal>
