...
const featureCards = [
  {
    icon: Piano,
    title: "Живой состав",
    text: "Пианино, гитара, баян, кахон. Никаких минусовок.",
  },
  {
    icon: Music,
    title: "Любимые песни",
    text: "От советских хитов до рок-музыки. Тексты на экране.",
  },
  {
    icon: Users,
    title: "Никакой сцены",
    text: "Все в одном круге (или в зале). Ведущий-хормейстер просто задаёт направление.",
  },
];
...
const audienceItems = [
  ...
  { icon: MessageCircle, text: "Тем, кто хочет живого общения" },
];
