...
export const comingSoonBranches = {
  ramenki: {
    ...
    announcement: {
      ...
      description: "Мастер-класс по хоровому пению в новой студии Громче в Раменках",
      price: "1 000 ₽ (можно зачесть в стоимость абонемента при оформлении в тот же день)",
      address: {
