        ...
        <div className="max-w-2xl mx-auto bg-card rounded-2xl p-5 md:p-8 border border-border/60 shadow-warm space-y-4 md:space-y-5">
          <div className="flex items-start gap-3 md:gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-foreground/80 leading-relaxed text-sm md:text-base">Москва, ул. Полковая, дом 3, (стр. без номера), 1 подъезд, 4 этаж, лофт Prostranstvo, зал «Салон» (10 мин от м. Марьина Роща)
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 pt-2 justify-center">
            <a
            href="https://yandex.ru/maps?whatshere%5Bpoint%5D=37.60377285481433%2C55.7993676276113&whatshere%5Bzoom%5D=19.395668&ll=37.60371460073145%2C55.79934274594268&z=19.395668&si=1q1yrg135cmxew4bz11ywrq8qw"
            target="_blank"
