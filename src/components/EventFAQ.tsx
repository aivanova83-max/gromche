...
const faqItems = [
  ...
  },
  {
    ...
    a: "Мы собираем его вместе с вами. При покупке билета нужно будет заполнить небольшой опрос: выбрать музыкальный жанр и указать 1–2 любимые песни. Эти ответы лягут в основу программы. Мы также ориентируемся на самые узнаваемые и хитовые треки — те, которые легко подхватываются и создают общий драйв.",
  },
  {
  ...
  },
  {
    ...
    a: "Да. Вечер проходит в формате девичника. Мы специально создаём пространство, где женщины могут расслабиться, чувствовать поддержку друг друга, петь, смеяться и быть в своей энергии — без напряжения и «внешних наблюдателей».",
  },
  {
    q: "Будет ли еда?",
